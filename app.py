...
def page_gastos():
    ...
    with st.form("new_expense"):
        ...
        amount = st.number_input("Monto", min_value=0.0, step=0.50, format="%.2f")
    ...
    if not gastos.empty:
        ...
        with st.expander("Editar un gasto"):
            ...
            with st.form("edit_expense_form"):
                ...
                edited_amount = st.number_input("Monto", min_value=0.0, value=float(to_float(row.get("monto", 0))), step=0.50, format="%.2f")
...
def page_saldos():
    ...
    with tab1:
        ...
        with st.form("saldo_adjust"):
            new_balance = st.number_input("Saldo real de Norte Brunch", min_value=0.0, step=0.50, value=float(max(bal["saldo_norte"], 0)), format="%.2f")
    ...
    with tab2:
        ...
        with st.form("debt_adjust"):
            new_debt = st.number_input("Deuda real de Norte Brunch hacia mí", min_value=0.0, step=0.50, value=float(max(bal["deuda"], 0)), format="%.2f")
    ...
    with tab3:
        ...
        with st.form("debt_pay"):
            amount = st.number_input("Monto para pagar deuda", min_value=0.0, max_value=float(max(min(bal["deuda"], bal["saldo_norte"]), 0)), value=float(max(suggested, 0)), step=0.50, format="%.2f")
...
def page_productos():
    ...
    with st.form("product_form"):
        ...
        price = st.number_input("Precio", min_value=0.0, value=float(to_float(default.get("precio", 0))), step=0.50, format="%.2f")
        profit = st.number_input("Ganancia personal", min_value=0.0, value=float(to_float(default.get("ganancia_personal", 0))), step=0.50, format="%.2f")
